...
export class FeedbackService extends BaseService {
  ...
  /** Path part for operation `sendFeedback()` */
  static readonly SendFeedbackPath = '/feedbacks';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `sendFeedback()` instead.
   *
   * This method sends `application/json` and handles request body of type `application/json`.
   */
  sendFeedback$Response(params: SendFeedback$Params, context?: HttpContext): Observable<StrictHttpResponse<number>> {
    return sendFeedback(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `sendFeedback$Response()` instead.
   *
   * This method sends `application/json` and handles request body of type `application/json`.
   */
  sendFeedback(params: SendFeedback$Params, context?: HttpContext): Observable<number> {
    return this.sendFeedback$Response(params, context).pipe(
