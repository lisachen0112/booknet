...
import dev.lschen.booknet.common.PageResponse;
import dev.lschen.booknet.exception.OperationNotPermittedException;
import dev.lschen.booknet.file.FileStorageService;
import dev.lschen.booknet.history.BookTransactionHistory;
import dev.lschen.booknet.history.BookTransactionHistoryRepository;
...
import static dev.lschen.booknet.book.BookSpecification.withOwnerId;
...
public class BookService {
    ...
    public Integer borrowBook(Integer bookId, Authentication connectedUser) {
        ...
        if (book.isArchived() || !book.isShareable()) {
            throw new OperationNotPermittedException("The requested book is either archived or not shareable. Cannot be borrowed");
        }
        User user = (User) connectedUser.getPrincipal();
        if (Objects.equals(book.getOwner().getId(), user.getId())) {
